...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-dark-950 text-slate-100 flex flex-col items-center justify-center p-6 grid-bg">
      <div className="w-full max-w-md bg-dark-900 border border-dark-800 rounded-2xl p-8 shadow-2xl">
        ...
        <h2 className="text-xl font-bold text-center text-white mb-2">Sign in to Control Plane</h2>
        <p className="text-xs text-center text-slate-400 mb-6">Access your production AI agent observability dashboard</p>
        ...
        <div className="mt-6 text-center text-xs text-slate-400">
          Demo Credentials Pre-Filled (alex@acmeai.com / password123)
        </div>
      </div>
    </div>
  );

      ...
      <div className="space-y-4">
        ...
        {project.agents.length === 0 ? (
          <div className="p-8 text-center text-xs text-slate-500 bg-dark-900 border border-dark-800 rounded-xl">
            No agents registered in this project yet. Click "+ New Agent" above to create your first agent.
          </div>
        ) : (
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {project.agents.map((agent: any) => (
              <div key={agent.id} className="bg-dark-900 border border-dark-800 rounded-xl p-5 space-y-3">
                <div className="flex items-center justify-between">
